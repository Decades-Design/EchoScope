...
// CALLBACK: Exchanges code for tokens, saves to DB, sends Session ID
router.get('/callback', async (req, res) => {
    ...
    try {
        ...
        const sessionId = await createSession(access_token, refresh_token, expires_in);
