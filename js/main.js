...
import { calculateGeographicBounds, setKmPerPixel, latLonToPixel, pixelToLatLon, NM_TO_KM} from './utils.js';
import { Aircraft } from './Aircraft.js';
import { drawNavData, setNavData } from './mapRenderer.js';
import { loadNavData } from './navDatabase.js';
import { getAircraftTagBoundingBox, getTagHitboxes, showTagInput, calculateTagLayout} from './ui.js';
...
async function initialize() {
    ...
    aircraftList.push(new Aircraft("BAW123", initialPos1.lat, initialPos1.lon, 135, 18000, 280, "EGLL", "LIMC", "H", 0, phase.CRUISE, canvas));
    aircraftList.push(new Aircraft("AWE456", initialPos2.lat, initialPos2.lon, 225, 24000, 310, "EDDF", "LIML", "M", 0, phase.CRUISE, canvas));
